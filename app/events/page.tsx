...
export default function EventsPage() {
  return (
    <main id="main-content" className="spotted-container py-20">
      ...
      <h1 className="display-type mt-4 text-5xl text-cream md:text-7xl">
        Las sesiones ahora viven en el archivo.
      </h1>
      <p className="mt-5 max-w-2xl text-lg leading-8 text-muted">
        Esta ruta se conserva por compatibilidad. Continúa al archivo para consultar sesiones
        publicadas y próximas.
      </p>
      <Link
        href="/sessions"
