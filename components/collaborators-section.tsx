  ...
  return (
    <section id="colaboradores" className="border-b border-line py-16 md:py-24">
      <div className="container-shell">
        <FadeIn>
          <SectionHeading
            eyebrow="Para colaboradores"
            title="Las grandes experiencias se construyen en equipo."
            body="SPOTTED funciona por sesiones. No buscamos gente disponible todos los días ni en todas las fechas. Buscamos personas talentosas y responsables que quieran sumarse al ecosistema y formar parte de una comunidad creativa retribuida."
          />
        </FadeIn>
